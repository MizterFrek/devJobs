<nav x-data="{ open: false }" class="bg-davysgrey border-b border-metalicsun">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                @auth
                    @can ('create', App\Models\Vacante::class)
                        ...
                        class="mr-2 w-7 h-7 bg-azul-1 hover:bg-azul-3
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        @auth
            <div class="pt-2 pb-3 space-y-1">
                ...
                <div class="flex gap-2 items-center p-3">
                    <a href="{{route('notificaciones')}}"
                    class="w-7 h-7 bg-azul-1 hover:bg-azul-3
                    rounded-full text-white flex justify-center items-center
                    font-extrabold text-sm">
                    {{ Auth::user()->unreadNotifications->count() }}
                    </a>
        ...
        @guest
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('login')" class="text-yellow">
                {{ __('Iniciar Sessión') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('register')" class="text-yellow">
                {{ __('Crear Cuenta') }}
            </x-responsive-nav-link>
        </div>
        @endguest
